...
def update_graph(start_date, end_date, wbs_value):
    ...
    eact_data['VACt'] = eact_data['EV'].expanding().mean() * len(eact_data)
    ...
    adjustment_factor2 = eact_data.loc[eact_data.index[-1], 'LB Costo COP'] / eact_data.loc[eact_data.index[-1], 'VACt']
    eact_data['VACt'] *= adjustment_factor2
